...
public class ConfirmOrderFrame extends MainFrame {
	...
	public ConfirmOrderFrame(Order orderToConfirm, MainFrame parent) {
		...
		this.arts.setBorder(createCompoundBorder(createTitledBorder("Voeding"), createEmptyBorder(0, 5, 0, 5))); // T,L,B,R
		...
		this.total.setBorder(createCompoundBorder(new ClickableTitledBorder("Totaal"), createEmptyBorder(0, 5, 0, 5))); // T,L,B,R
